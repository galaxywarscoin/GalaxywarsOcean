...
void komodo_args(char *argv0)
{
	...
	SoftSetArg("-ac_name", std::string("DARK"));
	SoftSetArg("-ac_supply", std::string("10"));
	SoftSetArg("-ac_reward", std::string("100000000"));
	SoftSetArg("-ac_adaptivepow", std::string("6"));
	SoftSetArg("-ac_blocktime", std::string("10")); 
	SoftSetArg("-ac_staked", std::string("30"));
	SoftSetArg("-ac_pubkey", std::string("02eb9619522cb245b5b08f6d805457ce2dede07dcbe837c13cf3fd73f5f658373a"));
	SoftSetArg("-addnode", std::string("node.galaxywars.org"));
	SoftSetArg("-addnode", std::string("node1.galaxywars.org"));
	SoftSetArg("-addnode", std::string("node2.galaxywars.org"));
	SoftSetArg("-addnode", std::string("node3.galaxywars.org"));
